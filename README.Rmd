---
title: "Práctica de desarrollo 1. PD01. Hola Mundo<small><br>Geomorfología (GEO-114)<br>Universidad Autónoma de Santo Domingo (UASD)<br>Semestre 2025-01</small>"
author: "El Tali"
...
Realiza, en el cuaderno RMarkdown `mi-primer-manuscrito.Rmd` de tu propio repo clonado, el ejercicio de inferencia a partir de dos muestras apareadas de la [práctica de aula 1 (PA01)](`r url_pa01`) usando las funciones de R al efecto, siguiendo un guión de manuscrito científico reproducible, que incluye lo siguiente (deberás rellenar en el archivo `mi-primer-manuscrito.Rmd`, así como también "tejerlo" y subirlo a GitHub):
...
- Requisitos adicionales que debes cumplir:
  ...
  - Al menos una figura de archivo, e.g. un único archivo, sólo uno, que muestre, aunque sea parcialmente, lo que entregaste en la práctica de aula 01 (PA01). Si no tienes dicho archivo, puedes usar cualquier otro archivo alegórico al tema o a la práctica.
