...
3. Verifica que eres miembro/a de la organización `r organizacion`. Si iniciaste sesión en GitHub, al entrar a la URL de la organización, debería ver que eres miembro/a en la sección "People". También puedes verlo en tu perfil de cuenta de GitHub, haciendo clic en tu avatar (en la página de GitHub, derecha superior), ve a "Your organizations" y debería ver la organización allí. De lo contrario, si no lo eres, pide que te envíe una invitación.

4. Acepta la invitación de GitHub Classroom de esta "Prácticas de desarrollo 1. Hola Mundo" (PD01).

5. Confirma que se creó tu repositorio en la organización `r organizacion`.
